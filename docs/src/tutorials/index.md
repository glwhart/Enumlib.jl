...
1. **[Your first enumeration](01-first-enumeration.md)** — `ParentLattice`, `Sites`, `enumerate_structures(...)` on a small `VolumeRange`. Inspect labelings and orbit sizes. ~5 minutes.
