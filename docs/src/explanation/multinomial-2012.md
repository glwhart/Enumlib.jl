...
Enumlib limits this with a `partition_threshold` kwarg on `enumerate_structures(...)` (default: 50). If the range decomposes into more partitions than the threshold, the response is one of:
